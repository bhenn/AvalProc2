...
@Code
    ViewData("Title") = "Atributos de Processo"
End Code

<h3>Atributos de Processo</h3>
...
<div id="updateDialog" title="Atributo de Processo"></div>
...
<script type="text/javascript">
    ...
    function createSuccess(data) {
        atualizaLista(data, "Atributo de Processo incluído com sucesso");
    }

    function updateSuccess(data) {
        atualizaLista(data, "Atributo de Processo atualizado com sucesso");
    }

    function deleteSuccess(data) {
        atualizaLista(data, "Atributo de Processo excluído com sucesso");
    }
