@ModelType IEnumerable(Of AvalProc.Categoria)
...
<div id="updateDialog" title="Categoria"></div>
...
<script type="text/javascript">
    ...
    function createSuccess(data) {
        atualizaLista(data, "Categoria incluída com sucesso");
    }

    function updateSuccess(data) {
        atualizaLista(data, "Categoria atualizada com sucesso");
    }

    function deleteSuccess(data) {
        atualizaLista(data, "Categoria excluída com sucesso");
    }
