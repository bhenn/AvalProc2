...
<div id="updateDialog" title="Empresa"></div>
...
<script type="text/javascript">
    ...
    function createSuccess(data) {
        atualizaLista(data, "Empresa incluída com sucesso");
    }

    function updateSuccess(data) {
        atualizaLista(data,"Empresa atualizada com sucesso");
    }

    function deleteSuccess(data) {
        atualizaLista(data, "Empresa excluída com sucesso");
    }
