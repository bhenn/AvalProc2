...
Namespace Migrations
    Public NotInheritable Partial Class avalprocessopa
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(avalprocessopa))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201306152356356_avalprocessopa"
            End Get
        End Property
