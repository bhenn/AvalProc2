...
Namespace Migrations
    Public NotInheritable Partial Class categoriaid
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(categoriaid))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201305302226330_categoriaid"
            End Get
        End Property
