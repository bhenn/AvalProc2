...
Namespace Migrations
    Public NotInheritable Partial Class avaliacaoavaliador
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(avaliacaoavaliador))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201306021833111_avaliacaoavaliador"
            End Get
        End Property
